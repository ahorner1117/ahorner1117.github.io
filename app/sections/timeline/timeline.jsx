...
const experiences= [
  ...
  const TimelineItem = ({ experience, side }) => {
    ...
    return (
      <div className={`relative text-sm w-full my-6 ${side === 'right' ? 'md:ml-auto' : 'md:mr-auto'} md:w-5/12 ${side === 'right' ? 'bg-black' : 'bg-black'} border border-gray-600 rounded-lg p-6 text-white`}>
      ...
      {/* Display bulleted list for the description */}
