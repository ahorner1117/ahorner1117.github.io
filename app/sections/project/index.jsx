...
const projects = [
	...
	},
	{
		...
		imageUrl:
			"https://simplylistedmarketing.com/wp-content/uploads/2023/10/Original-Logo-1.png",
		caseStudyUrl: "#",
		tools: {
			FaWordpress: "Wordpress",
			"devicon-php-plain": "PHP",
...
export const ProjectsSection = () => {
	return (
		<div id="projects" className="bg-transparent text-white py-16">
			...
			<h2 className="text-3xl font-extrabold tracking-tight text-center mb-20 ">E-Commerce Projects</h2>
