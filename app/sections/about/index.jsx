				...
				{isContentVisible && (
					<div className="pt-10 pb-16 max-w-5xl flex flex-col gap-3">
						...
						>
							...
							<p className="my-3.5">
								Throughout my career, I have undertaken various projects that showcase my expertise
								in web development. For instance, I developed multiple customizable, headless
								Next.js and React ECommerce stores on the Shopify platform. Leveraging GraphQL for
								API calls, I utilized Shopify Admin API and Storefront API. Additionally, I
								implemented custom hooks, employed Redux for efficient state management, and
								integrated Contentful headless CMS using GraphQL queries and mutations.
							</p>
							<p className="my-3.5">
							...
							<p className="my-3.5">
								...
								creating QR codes with augmented reality using JavaScript, and integrating
								JavaScript and jQuery to synchronize Shopify buy buttons and shopping carts across
								multiple domains. I have also designed and implemented theme 2.0 landing pages for
								Shopify with drag-and-drop functionality.
							</p>
							<p className="my-3.5">
								...
								based on call disposition. I also crafted personalized email signatures for the
								entire company using HTML and CSS, ensuring consistency and professionalism in
								communication.
							</p>
						</div>
					</div>
